...
const SolarChart = ({ labels, realData, predictedData, diffDays, showPrediction, comparisonMode, multiLineData = null, isCompareChart = false }) => {
    ...
    const ctx = canvasRef.current.getContext('2d');
        ...
        if (isCompareChart && multiLineData) {
          datasets = multiLineData.map((line, idx) => {
            // ถ้ามีการเลือกเส้น ให้เส้นที่เลือกเด่นชัด เส้นอื่นจาง
            ...
            return {
              ...
              // Chart.js v4+ supports parsing borderColor as a function, but fallback to segment for v3
