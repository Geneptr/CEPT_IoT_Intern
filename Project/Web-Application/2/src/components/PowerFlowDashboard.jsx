...
export default function PowerFlowDashboard() {
  ...
  const totalWatt = components.reduce((sum, c) => sum + (c.watt || 0), 0);
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-between">
      <main className="flex-1 flex flex-col items-center justify-center relative">
        ...
        >
          ...
          <div className="absolute left-[7%] right-[7%] top-1/2 -translate-y-1/2 h-1 z-15 overflow-visible pointer-events-none">
            ...
            <ArrowLine
              className={
                "absolute top-1 left-0 w-full -translate-y-1/2 z-10 overflow-visible"
              }
              count={6}
            />{" "}
          ...
          {components[1] && (
            ...
            >
              ...
              >
                ...
                <ArrowLine
                  className={
                    "rotate-90 absolute -left-1 w-full -translate-x-1/2 z-5 overflow-visible"
                  }
                  count={6}
                />{" "}
                {/* ลูกศรเคลื่อนไหวบนเส้นกลางจากซ้ายไปขวา */}
          ...
          {components[2] && (
            ...
            >
              ...
              >
                ...
                <ArrowLine
                  className={
                    "rotate-90 absolute -left-1 -top-1 w-full -translate-x-1/2 z-5 overflow-visible"
                  }
                  count={6}
                />{" "}
                {/* ลูกศรเคลื่อนไหวบนเส้นกลางจากซ้ายไปขวา */}
                <ArrowLine
                  className={
                    "rotate-270 absolute left-2 -top-10 w-full -translate-x-1/2 z-5 overflow-visible"
                  }
                  count={6}
                  color="red"
                />{" "}
          ...
          {components[3] && (
            ...
            >
              ...
              >
                ...
                {/* ลูกศรวิ่งลง (แนวตั้ง)  */}
                <ArrowLine
                  className="rotate-90 absolute -left-1 -top-1 w-full -translate-x-1/2 z-5 overflow-visible"
                  count={6}
                />

                {/* ลูกศรวิ่งขวา (แนวนอนชนเส้นหลัก)  */}
                <ArrowLine
                  className="rotate-270 absolute left-2 -top-10 w-full -translate-x-1/2 z-5 overflow-visible"
                  count={6}
          ...
          {components[5] && (
            ...
            >
              ...
              >
                ...
                {/* ลูกศรวิ่งลง (หมุน 90°) */}
                <ArrowLine
                  className="rotate-90 absolute -left-1 top-0 w-full -translate-x-1/2 z-10 overflow-visible"
                  count={6}
                />
              </div>
            </div>
          ...
          {components[7] && (
            ...
            >
              ...
              />
              <div
                className="absolute left-59 top-1/2 -translate-y-1/2 ml-6 select-none pointer-events-none whitespace-nowrap px-2 rounded shadow-md border border-gray-300 bg-white/90"
                style={{ fontWeight: 600, fontSize: "1.18rem" }}
              >
      ...
      <footer className="w-full bg-white border-t border-gray-200 py-4 flex flex-col items-center shadow-sm">
        <div className="text-gray-700 text-base md:text-lg font-semibold">
          Total Power Usage:{" "}
          <span className="text-blue-600 font-bold">{totalWatt} W</span>
        </div>
